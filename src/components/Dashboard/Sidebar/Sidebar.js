import { faCalendar, faCog, faNotesMedical, faSignOutAlt, faTh, faUser, faUsers } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <aside className="sidebar position-relative">
            <ul className="list-unstyled">
                ...
                <li><Link to="/dashboard/patients"><FontAwesomeIcon className="me-2" icon={faUsers}/> Patients</Link> </li>
                <li><Link to="/prescriptions"><FontAwesomeIcon className="me-2" icon={faNotesMedical}/> Prescriptions</Link> </li>
                <li><Link to="/add-doctors"><FontAwesomeIcon className="me-2" icon={faUser}/> Add Doctors</Link> </li>
